...
public static void readLine(){
  ...
  \begin{aufgabe}
  	...
  	\\
  	\textbf{Note:} If your desired class does not exist in your current context, you can add \textit{Accessories Models} by right-clicking onto \menu[,]{de.tudo.cs.ls14.aqua.mps.workshop.java, Module Properties}. Navigate to \menu[,]{Runtime, Accessories Models} and add the required models using the \texttt{+} button, e.g. \textit{java.io@java\_stub}.
  \end{aufgabe}
