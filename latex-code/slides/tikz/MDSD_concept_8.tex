...
\node at (6,-2.85) {\includegraphics[width=0.007\textwidth]{../graphics/textgen.png} {\fontsize{6}{6}\selectfont Text Gen}};
\node at (6,-2.55) {\includegraphics[width=0.007\textwidth]{../graphics/generator.png} {\fontsize{6}{6}\selectfont Generator}};
\draw (0.525,-2.775) edge[dashed, -latex] (5.175,-2.775);

\draw (8.175,0.525) rectangle (9.9,-0.375);
\node at (9.075,0.375) {\includegraphics[width=0.007\textwidth]{../graphics/checkingrules.png} {\fontsize{6}{6}\selectfont Checks}};
\node at (9.075,0.15) {\includegraphics[width=0.007\textwidth]{../graphics/typesystem.png} {\fontsize{6}{6}\selectfont Typesystem}};
\node at (9.075,-0.075) {\includegraphics[width=0.007\textwidth]{../graphics/dataflow.png} {\fontsize{6}{6}\selectfont Dataflow}};
\node at (9.075,-0.28) {\includegraphics[width=0.007\textwidth]{../graphics/constraints.png} {\fontsize{6}{6}\selectfont Constraints}};
